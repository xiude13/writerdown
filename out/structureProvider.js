...
exports.StructureProvider = exports.StructureTreeItem = void 0;
const path = require("path");
const vscode = require("vscode");
class StructureTreeItem extends vscode.TreeItem {
    constructor(structureInfo, collapsibleState) {
...
exports.StructureTreeItem = StructureTreeItem;
    ...
    buildHierarchy() {
        ...
        for (const [fileName, items] of fileGroups) {
            ...
            for (const item of items) {
                const treeItem = new StructureTreeItem(item, item.type === 'section' ? vscode.TreeItemCollapsibleState.None : vscode.TreeItemCollapsibleState.Expanded);
                if (item.type === 'act') {
